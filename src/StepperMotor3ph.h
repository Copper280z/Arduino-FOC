...
/**
 Stepper Motor class
*/
class StepperMotor3ph: public FOCMotor
{
  public:
    /**
    ...
    */
    StepperMotor3ph(int pp,  float R = NOT_SET, float KV = NOT_SET, float L = NOT_SET);
    ...
    */
    ...
    float	Ualpha,Ubeta, Umin, Umax, Vo; //!< Phase voltages U alpha and U beta used for inverse Park and Clarke transform
